...
from faq_crawling.crawler_runner import crawl_evdang_questions
...
def render_faq_search_page() -> None:
    ...
    if st.button("EVDang 크롤링 실행", type="primary"):
        try:
            with st.spinner("EVDang 게시글을 수집하고 있습니다."):
                question_df = crawl_evdang_questions(
                    selected_keyword,
